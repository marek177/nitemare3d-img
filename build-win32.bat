...
echo Building Nitemare 3D IMG Editor for Windows x86 using .NET 8...

if exist "publish\win-x86" rmdir /s /q "publish\win-x86"

dotnet restore "Nitemare3D.ImgEditor.csproj" -r win-x86
...
echo Output: %~dp0publish\win-x86\
pause
exit /b 0
